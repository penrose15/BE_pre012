package com.codestates.pre012.config.oauth;


import com.codestates.pre012.config.oauth.provider.FacebookUserInfo;
import com.codestates.pre012.config.oauth.provider.GoogleUserInfo;
import com.codestates.pre012.config.oauth.provider.NaverUserInfo;
import com.codestates.pre012.config.oauth.provider.OAuth2UserInfo;
